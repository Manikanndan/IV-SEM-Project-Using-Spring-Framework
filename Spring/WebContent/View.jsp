                ...
                <div class="pro">
                    ...
                    <div class="sectionblock">
                      ...
                      <c:forEach var="listValue" items="${list}">
                        <img  class="prod-1" src="Images/${listValue.imagename}">
                       
                        <div class="container1">
					        <h2 name="itemname" class="hi">${listValue.itemname}</h2>
					        <p name="itemprice" class="title">${listValue.itemprice}</p>
					        <p name="itemoffer" class="title1">${listValue.itemoffer}%-Offer</p>
					        <input type="hidden" name="id" value="${listValue.itemid }">
					        <%-- <p>${ view.itemquantity}</p> --%>
					        
					        <select class="title2" name="qty" >
					       
					        <c:forEach begin="1" end="${listValue.itemquantity}" varStatus="loop" >
					 ...
					 <%-- < name="itemid" href="Pay.html?id=${listValue.itemid}" class="btn1">Buy Now</a> --%>
                        <%-- <a href="Pay.html?id=${listValue.itemid}" class="btn1">Buy Now</a> --%>
                        <%-- <a href="Pay.html?id=${listValue.itemid }" class="btn2" >Buy Now</a> --%>
                        </c:forEach>
                       </form>
                    </div>
