 ...
 Select u=(Select) session.getAttribute("user");
  ...
  %>
    ...
    <body>
        ...
        <form action="ProductView.html" method="get">
        <section-1>
                <div class="pro">
               
                    <div class="sectionblock">
                      
                        <img  class="prod-1" src="Images/${view.imagename }">
                        
                        <div class="container1">
					        <h2 class="hi">${view.itemname}</h2>
					        <p class="title">${view.itemprice}</p>
					        <p >${view.itemoffer}</p>
					        <p>${ view.itemquantity}</p>
					     </div>	 
                        <a href="#" class="btn1">Add to Cart</a>
                        <a href="Payment.html?id=${view.itemid }" class="btn2">Buy Now</a>
